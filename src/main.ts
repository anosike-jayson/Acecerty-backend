...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    ...
    .addTag('Exam Vouchers', 'Official vendor exam vouchers — public read + admin CRUD')
    ...
    .addTag('Learning', 'Student dashboard, certificates & lesson progress (LMS)')
    .addTag('Leads', 'Instructor applications, newsletter & contact capture')
